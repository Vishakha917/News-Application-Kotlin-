...
import com.kotlin.mvvmnewsapp.NewsApplication
...
class NewsViewmodel(app: Application, val newsRepository: NewsRepository) : AndroidViewModel(app) {
    ...
    // viewModelScope -> means this coroutine will be alive as long this viewModel is alive.
    ...
    private fun hasInternetConnection(): Boolean {
        val connectivityManager =
            getApplication<NewsApplication>().getSystemService(Context.CONNECTIVITY_SERVICE) as
                    ConnectivityManager
